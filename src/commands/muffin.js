...
module.exports = {
	...
	async execute(interaction) {
      ...
      .setThumbnail("https://raw.githubusercontent.com/Cresfy/Muffin/master/assets/muff.png")
      .addFields(
        { name: "Features", value: "Moderation, Music, Polls, Fully customizable level system, 1v1 with mmr system and leaderboards." },
        { name: "\u200B", value: "\u200B" },
        {name: "Command List:", value: "/muffin\n/settings\n/latency\n/clear [amount]\n/play [SongName]\n/user\n/server\n/poll\n/level\n/roinfo\n/1v1\n/mmr\n/leaderboard", inline: true}
      )
